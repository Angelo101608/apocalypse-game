...
var packageBody,ground, background, backroundIMG;
var box1, box2, box3;
...
function preload()
{
	...
	backroundIMG=loadImage("Photos/Apocalypse-or-war-zone-scene-creation-game-assets.png");
...
function setup() {
	...
	backround=createSprite(width/2, 350, 100, 100);
	...
	helicopterSprite=createSprite(395, 200, 10,10);
